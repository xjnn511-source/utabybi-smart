    ...
    <div className="card-neon p-5">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-[10px] text-text-dim">حاسبة رسوم التسويق والبر</p>
        </div>
      </div>
      ...
      <input
        ...
        className="w-full h-9 px-3 rounded-lg border border-border bg-secondary text-xs text-foreground placeholder:text-text-dim focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-colors mb-3"
      />

      <div className="grid grid-cols-2 gap-3">
        <div className="p-3 rounded-lg bg-primary/5 border border-primary/20 text-center">
          <p className="text-[10px] text-text-dim mb-1">٥٪ لوالديك</p>
          <p className="text-lg font-bold neon-text">
            {numPrice > 0 ? parentsShare.toLocaleString("ar-SA") : "—"}
          </p>
          <p className="text-[9px] text-text-dim mt-0.5">ريال</p>
        </div>
        <div className="p-3 rounded-lg bg-secondary border border-border text-center">
          <p className="text-[10px] text-text-dim mb-1">0.5% رسوم التسويق</p>
