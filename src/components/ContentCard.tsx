    ...
    <div className="card-neon p-5 relative">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-[10px] text-muted-foreground">توليد حلول برمجية احترافية بأنظمة برمجية مؤتمتة</p>
        </div>
      </div>
      ...
      <div className="aspect-[4/3] max-h-40 rounded-lg overflow-hidden mb-3 relative bg-secondary border border-border">
        {isCreating ? (
          <div className="absolute inset-0 flex flex-col gap-2 items-center justify-center">
            ...
            <p className="text-[10px] text-muted-foreground">جاري توليد الحلول البرمجية...</p>
          </div>
        ) : posterReady ? (
          <div className="absolute inset-0 bg-primary/5 flex flex-col items-center justify-center p-3">
            ...
            <p className="text-xs text-primary font-bold text-center">حلول برمجية احترافية جاهزة</p>
            <p className="text-[10px] text-muted-foreground mt-1">جاهز للتحميل والمشاركة</p>
          </div>
        ) : (
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="text-[10px] text-muted-foreground">معاينة الحلول البرمجية</p>
          </div>
        )}
      </div>
