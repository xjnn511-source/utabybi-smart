  ...
  return (
    <div className="bg-secondary/50 border border-border rounded-2xl p-6 shadow-sm">
      ...
      <p className="mt-4 text-[9px] text-muted-foreground leading-relaxed border-r-2 border-primary pr-3">
        جميع خدمات منصة "عُتيبي ذكي Ai" هي أدوات برمجية تقنية (SaaS) مطورة بواسطة فريق عُتيبي ذكي.
        الرسوم المحصلة هي مقابل اشتراكات برمجية لاستخدام المحركات الذكية، ولا تقدم المنصة خدمات وساطة أو ترويج.
      </p>
    </div>
  );
};
