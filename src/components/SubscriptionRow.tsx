...
const plans = [
  {
    ...
    price: "0",
    icon: Gift,
    features: ["عمليات برمجية محدودة", "معالجة وسائط رقمية واحد", "معالجة نصية (150 حرف)"],
    highlight: false,
    isFree: true,
  },
  {
    ...
    price: "99",
    icon: Crown,
    features: ["معالجة مستندات برمجية", "10 خدمات تقنية شهرياً", "2,000 حرف/شهر", "أنظمة أتمتة برمجية"],
    highlight: false,
    isFree: false,
  },
  {
  ...
  return (
    <>
      ...
      <p className="text-[9px] text-muted-foreground text-center px-6 pb-3">
        وثيقة العمل الحر: FL-822675484 | المنصة الرسمية للحلول البرمجية المؤتمتة والمعالجة الرقمية
      </p>
    </>
  );
};
