...
const plans = [
  {
    ...
    price: "0",
    icon: Gift,
    features: ["تحليل بيانات تجريبي", "نموذج فيديو Ai واحد", "معالجة صوتية (150 حرف)"],
    highlight: false,
    isFree: true,
  },
  {
    ...
    price: "99",
    icon: Crown,
    features: ["تطوير عروض برمجية", "10 خدمات تقنية شهرياً", "2,000 حرف/شهر", "محرك الذكاء الاصطناعي"],
    highlight: false,
    isFree: false,
  },
  {
