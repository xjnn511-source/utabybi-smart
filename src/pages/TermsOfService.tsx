...
const TermsOfService = () => (
  <div className="min-h-screen bg-background p-6 max-w-2xl mx-auto" dir="rtl">
    ...
    <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
      <p>باستخدامك لمنصة "عُتيبي ذكي" – منصة برمجية لتطوير البرمجيات والحلول المؤتمتة – فإنك توافق على الالتزام بالشروط والأحكام التالية.</p>
      <h2 className="text-lg font-semibold text-foreground">الخدمات المقدمة</h2>
      <p>تقدم المنصة حلول برمجية متقدمة تعتمد على أنظمة برمجية مؤتمتة لمعالجة البيانات، توليد حلول برمجية، ومعالجة وسائط تقنية. المنصة أداة تقنية مساعدة ولا تُعدّ بديلاً عن الاستشارة المتخصصة.</p>
      ...
      <p>المسؤولية النهائية عن دقة البيانات المدخلة والمخرجات تقع على عاتق المستخدم. المنصة لا تتحمل أي مسؤولية قانونية عن نتائج المعالجة أو المحتوى المُولّد.</p>
      <h2 className="text-lg font-semibold text-foreground">حقوق الملكية</h2>
      <p>جميع المحتويات والعلامات التجارية مملوكة لـ "عُتيبي ذكي". يُمنع نسخ أو إعادة استخدام أي محتوى دون إذن مسبق.</p>
    </div>
  </div>
);
