...
const TermsOfService = () => (
  <div className="min-h-screen bg-background p-6 max-w-2xl mx-auto" dir="rtl">
    ...
    <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
      ...
      <p>تقدم المنصة حلول SaaS متقدمة تعتمد على الذكاء الاصطناعي لمعالجة البيانات، إنشاء محتوى تسويقي، ومعالجة وسائط تقنية. المنصة أداة تقنية مساعدة ولا تُعدّ بديلاً عن الاستشارة المتخصصة.</p>
