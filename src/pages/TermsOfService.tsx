...
const TermsOfService = () => (
  <div className="min-h-screen bg-background p-6 max-w-2xl mx-auto" dir="rtl">
    ...
    <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
      <p>باستخدامك لتطبيق "عُتيبي ذكي Ai"، فإنك توافق على الالتزام بالشروط والأحكام التالية.</p>
      <h2 className="text-lg font-semibold text-foreground">الخدمات المقدمة</h2>
      <p>يقدم التطبيق أدوات ذكاء اصطناعي لتحليل الصكوك العقارية، إنشاء عروض تسويقية، ومونتاج فيديو احترافي. التطبيق أداة مساعدة ولا يُعدّ بديلاً عن الاستشارة القانونية.</p>
