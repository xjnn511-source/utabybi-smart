...
const TermsOfService = () => (
  <div className="min-h-screen bg-background p-6 max-w-2xl mx-auto" dir="rtl">
    ...
    <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
      ...
      <p>المسؤولية النهائية عن دقة البيانات المدخلة والمخرجات تقع على عاتق المستخدم. المنصة لا تتحمل أي مسؤولية قانونية عن نتائج التحليل أو المحتوى المُولّد.</p>
