        ...
        <div className="flex-1 flex flex-col max-w-md mx-auto relative pb-20">
          ...
          <div className="bg-card/80 border-b border-border overflow-hidden py-2.5">
            <div className="animate-marquee whitespace-nowrap flex gap-10 text-[11px] font-bold text-primary">
              <span>🎬 المحرر الذكي للمونتاج يعمل بمحرك Google Gemini Pro</span>
              <span>🚀 معالجة برمجية مؤتمتة لكل ملف يُرفع تلقائياً</span>
              <span>🔊 دمج صوتك الشخصي المستنسخ في كل إنتاج</span>
              <span>🎬 المحرر الذكي للمونتاج يعمل بمحرك Google Gemini Pro</span>
            </div>
          </div>
          ...
          <main className="space-y-8 p-4 mt-4">
            ...
            {/* الأدوات مقفلة حتى التحقق من الإيصال */}
            <LockGate label="لوحة الأدوات مقفلة">
              <div className="space-y-8">
                <h2 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <Film className="w-4 h-4 text-primary" />
                  المحرر الذكي للمونتاج والمعالجة البرمجية المؤتمتة
                </h2>

                {/* المحرر الذكي للمونتاج — المعالجة البرمجية المؤتمتة */}
                <SmartMontageEditor />

                {/* صوتي الشخصي المستنسخ */}
                <VoiceCard />

                {/* قسم الامتثال البرمجي */}
                <ComplianceSection />
              </div>
            </LockGate>
