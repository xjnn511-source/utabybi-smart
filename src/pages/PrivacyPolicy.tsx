...
const PrivacyPolicy = () => (
  <div className="min-h-screen bg-background p-6 max-w-2xl mx-auto" dir="rtl">
    ...
    <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
      ...
      <p>نجمع المعلومات التي تقدمها لنا مباشرةً مثل الاسم، البريد الإلكتروني، ورقم الجوال عند التسجيل. كما نجمع البيانات التي ترفعها للتحليل البرمجي ومعالجة الذكاء الاصطناعي.</p>
      <h2 className="text-lg font-semibold text-foreground">كيف نستخدم بياناتك</h2>
      <p>نستخدم بياناتك لتقديم خدمات التحليل بالذكاء الاصطناعي، تطوير الحلول البرمجية، تحسين تجربة المستخدم، ومعالجة الاشتراكات.</p>
