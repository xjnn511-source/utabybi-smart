...
const PrivacyPolicy = () => (
  <div className="min-h-screen bg-background p-6 max-w-2xl mx-auto" dir="rtl">
    ...
    <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
      <p>نحن في "عُتيبي ذكي" – منصة برمجية متخصصة في تطوير البرمجيات والحلول المؤتمتة – نلتزم بحماية خصوصية مستخدمينا.</p>
      <h2 className="text-lg font-semibold text-foreground">البيانات التي نجمعها</h2>
      <p>نجمع المعلومات التي تقدمها لنا مباشرةً مثل الاسم، البريد الإلكتروني، ورقم الجوال عند التسجيل. كما نجمع البيانات التي ترفعها للمعالجة البرمجية ومعالجة الأنظمة البرمجية المؤتمتة.</p>
      <h2 className="text-lg font-semibold text-foreground">كيف نستخدم بياناتك</h2>
      <p>نستخدم بياناتك لتقديم خدمات معالجة البيانات، توليد الحلول بأنظمة برمجية مؤتمتة، تحسين تجربة المستخدم، ومعالجة الاشتراكات.</p>
